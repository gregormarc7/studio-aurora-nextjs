    ...
    <section id="apartma" className="scroll-mt-24 bg-gray-50 py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="mt-3 mb-12 text-center text-lg text-gray-700 max-w-3xl mx-auto">
          ...
          soseski Izole, 10&nbsp;min hoje od plaže in 2&nbsp;minuti od priljubljene
          kolesarske poti Parenzana.
        </p>

        {/* ----- slika + opis + “čipke” ----- */}
        <div className="grid lg:grid-cols-[minmax(0,640px)_1fr] gap-14">
      ...
      <div className="container mx-auto mt-24 text-center">
        ...
        <div className="relative group mx-auto max-w-screen-lg rounded-xl overflow-hidden">
          ...
          >
            <span className="w-10 h-10 bg-white text-[#2DC6F7] rounded-full shadow border
                             border-black flex items-center justify-center text-xl font-bold">+
            </span>
          </button>
        </div>
