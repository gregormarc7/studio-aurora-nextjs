  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-10 px-4">
      <div className="max-w-6xl mx-auto w-full">
        {/* Glavna mreža s centriranjem */}
        <div className="grid md:grid-cols-3 gap-10 text-sm text-gray-700 justify-items-center text-center md:text-left md:justify-items-start">
