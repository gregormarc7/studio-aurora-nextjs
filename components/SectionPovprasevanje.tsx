    ...
    <section id="povprasevanje" className="bg-gray-50 py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-center text-4xl font-bold mt-1">
          Rezervirajte svoj <span className="text-[#2DC6F7]">dopust</span>
        </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          {/* Leva stran */}
          <div className="space-y-6" aria-label="Kontaktni podatki">
            <ContactInfo icon={<HiOutlineMail />} label="Email" value="studioauroraizola@gmail.com" />
            <ContactInfo
              icon={<HiOutlinePhone />}
              label="Telefon"
              value="+386 41 430 460 ali +386 40 585 604"
            />
            <ContactInfo
              icon={<HiOutlineLocationMarker />}
              label="Lokacija"
              value="Na terasah 2, 6310 Izola, Slovenija"
            />
            ...
            <div className="bg-white rounded-xl shadow px-6 py-4 mt-4">
              ...
              <ul className="text-sm mt-2 space-y-1" aria-label="Informacije o prijavi in odjavi">
          ...
          <form
            ...
            aria-label="Obrazec za povpraševanje"
          >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="relative">
                {!form.arrival && (
                  <span className="absolute left-4 top-2 text-sm text-gray-400 pointer-events-none">
                    Datum prihoda
                  </span>
                )}
                <input
            ...
            <button
              ...
              className="w-full bg-[#2DC6F7] text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-500 transition"
            >
