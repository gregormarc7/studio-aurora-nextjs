    ...
    <section id="domov" className="relative h-[90vh] flex items-center justify-center text-white text-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-3xl px-6">
        ...
        <div className="flex gap-4 justify-center">
          <a href="#rezervacija" className="px-6 py-3 bg-white text-accent font-semibold rounded-full shadow-lg hover:scale-105 transition">Rezerviraj zdaj</a>
          <a href="#galerija" className="px-6 py-3 border border-white rounded-full hover:bg-white hover:text-accent transition">Poglej galerijo</a>
        </div>
      </div>
    </section>
  )
